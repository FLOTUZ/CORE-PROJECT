...
CREATE TABLE IF NOT EXISTS `core`.`aspel` (
  ...
  `P_WWC` TINYINT NULL DEFAULT 0 COMMENT 'Publicado en wooCommerce? [0]: Si   [1]: No',
  `DESC_LARGA` TEXT NULL DEFAULT 'no existe descripcion para este producto',
  ...
  `FCH_ULTVTA` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Fecha de última venta',
